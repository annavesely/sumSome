...
#' @usage sumStats_old(G, S = NULL, alternative = "greater", alpha = 0.05,
...
#' res <- sumStats_old(G, S, alpha = 0.4, truncFrom = 0.7, truncTo = 0)
#' res
#' summary(res)
#' 
...
sumStats_old <- function(G, S=NULL, alternative="greater", alpha=0.05, truncFrom=NULL, truncTo=NULL, nMax=50){
  ...
  out <- sumTest_old(res$G, S, alpha, res$truncFrom, res$truncTo, nMax)
  return(out)
}
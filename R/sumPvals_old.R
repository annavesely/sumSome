...
#' @usage sumPvals_old(G, S = NULL, alpha = 0.05, truncFrom = NULL, truncTo = 0.5,
...
#' res <- sumPvals_old(G, S, alpha = 0.4, r = -1)
#' res
#' summary(res)
#' 
...
sumPvals_old <- function(G, S=NULL, alpha=0.05, truncFrom=NULL, truncTo=0.5, type="vovk.wang", r=0, nMax=50){
